  ...
  return (
    <>
      ...
      <main className="relative bg-zinc-100 dark:bg-zinc-950 min-h-screen text-zinc-900 dark:text-zinc-100 overflow-clip transition-colors duration-500">
        {/* The Unified Hero & Gallery Viewport (100vh) */}
        {/* Both the Mask and the Gallery will share this exact space */}
        <div
          className="relative w-full h-screen overflow-hidden bg-white dark:bg-black shadow-[0_-20px_50px_rgba(0,0,0,0.3)] z-10"
